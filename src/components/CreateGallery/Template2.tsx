...
function Template2({ images, dimensions, templateHeight, templateWidth }: any) {
                ...
                <div
                    ...
                    <div className={` w-[30%] flex gap-2 flex-col`}>
                        <div className=" h-[50%] items-center justify-center flex rounded-md bg-gray-700
                            overflow-hidden transition ease-in-out duration-300 hover:scale-95 ">
                            <img src={`${process.env.NEXT_PUBLIC_CDN_URL}=${images[1].src}`} alt="Image2"
                        ...
                        <div className=" h-[50%] items-center justify-center flex rounded-md bg-gray-700
                            overflow-hidden transition ease-in-out duration-300 hover:scale-95 ">
                            <img src={`${process.env.NEXT_PUBLIC_CDN_URL}=${images[2].src}`} alt="Image3"
                    ...
                    <div className={` w-[30%] flex gap-2 flex-col`}>
                        <div className=" h-[50%] items-center justify-center flex rounded-md bg-gray-700
                            overflow-hidden transition ease-in-out duration-300 hover:scale-95 ">
                            <img src={`${process.env.NEXT_PUBLIC_CDN_URL}=${images[3].src}`} alt="Image2"
